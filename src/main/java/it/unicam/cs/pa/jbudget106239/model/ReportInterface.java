...
/**
 * Permette di creare un report generale con i metodi per scriverlo e leggerlo
 */
public interface ReportInterface {
     LinkedList getReport() throws IOException;
     void setReport(LinkedList report);
     void writeOnReport(String text, double money) throws IOException, SignException;
}
